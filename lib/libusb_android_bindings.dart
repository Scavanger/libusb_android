...
/// Bindings for `src/libusb/libusb.h`.
class LibusbAndroidBindings {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  LibusbAndroidBindings(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  LibusbAndroidBindings.fromLookup(
...
abstract class libusb_bos_type {
  ...
  static const int LIBUSB_BT_SUPERSPEED_PLUS_CAPABILITY = 10;
}
...
abstract class libusb_superspeedplus_sublink_attribute_sublink_type {
  static const int LIBUSB_SSPLUS_ATTR_TYPE_SYM = 0;
  static const int LIBUSB_SSPLUS_ATTR_TYPE_ASYM = 1;
}

/// \ingroup libusb_desc
/// enum used in \ref libusb_ssplus_sublink_attribute
abstract class libusb_superspeedplus_sublink_attribute_sublink_direction {
  static const int LIBUSB_SSPLUS_ATTR_DIR_RX = 0;
  static const int LIBUSB_SSPLUS_ATTR_DIR_TX = 1;
}
...
/// Mb = Mbps
/// Gb = Gbps
abstract class libusb_superspeedplus_sublink_attribute_exponent {
  static const int LIBUSB_SSPLUS_ATTR_EXP_BPS = 0;
  static const int LIBUSB_SSPLUS_ATTR_EXP_KBS = 1;
  static const int LIBUSB_SSPLUS_ATTR_EXP_MBS = 2;
  static const int LIBUSB_SSPLUS_ATTR_EXP_GBS = 3;
}

/// \ingroup libusb_desc
/// enum used in \ref libusb_ssplus_sublink_attribute
abstract class libusb_superspeedplus_sublink_attribute_link_protocol {
  static const int LIBUSB_SSPLUS_ATTR_PROT_SS = 0;
  static const int LIBUSB_SSPLUS_ATTR_PROT_SSPLUS = 1;
}
...
abstract class libusb_speed {
  ...
  static const int LIBUSB_SPEED_SUPER_PLUS_X2 = 6;
}
